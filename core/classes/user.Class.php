...
class User{
        ...
        if(isset($email) && isset($pass)){
            ...
            if(empty($email) or empty($pass)){
                ...
                if ($user->rowCount() == 0){
                    ...
                    echo ("<script>location.href = '/sign up register/?a=dashboard';</script>");
                }
            }
        }
        return $result;
    ...
    function LoginForm(){
        return '
            <div class="form_block">
                <div id="title">Login to your account</div>
                <div class="body">' .
                    ($_POST ? $this->CheckLoginData($_POST['email'], $_POST['pass']) : '')
                    . '<form id="logform" action="?a=login" method="POST">
                        <input type="text" name="email" placeholder="Email">
                        <input type="password" name="pass" placeholder="Password">
                        <input type="submit" value="Enter"> <a class="regBtn" href="?a=register">Register Here</a>
                    </form>
                </div>
            </div>
        ';
    ...
    function RegisterForm(){
        return '
            <div class="form_block">
                <div id="title">Register here for additional travel features</div>
                <div class="body">' .
